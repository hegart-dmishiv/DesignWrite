...
TiddlyWiki's tiddler titles are case sensitive, so "[[You]]" and "[[you]]" do not link to the same tiddler. This has become an issue for me when completing this exercise. Rather than creating two of every word tiddler, one for lowercase words and one for titlecase words, I have forced lowercase only for the [[Green Eggs and Ham vocabulary|geah-vocab]], with the exception of "[[I]]" and "[[Sam]]", both of which are naturally titlecase only. Wherever a word uses titlecase, I force the link to lowercase, using the following structure...
